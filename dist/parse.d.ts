import { type Dayjs, type DayjsInput, type ISODate, type ISODateString } from "./base";
 ...
 * @see toISODate
 */
export declare function parseISODateOrError(value: DayjsInput, options?: Omit<ParseOptions, "strict">): ISODate;
/**
 * it returns a Dayjs object (in UTC) serialized as ISODate representing the given date, unless:
 * - it receives null, or empty string (then returns null)
 * - it produces an invalid Dayjs (then returns null)
 ...
 * @see toISODate
 */
export declare function parseISODate(value: DayjsInput, options?: ParseOptions): ISODate | null;
/**
 ...
 * @param x
 */
export declare function asISODate(x: DayjsInput): ISODate | null;
/**
 ...
 * @param x
 */
export declare function asISODateOrError(x: DayjsInput): ISODate;
